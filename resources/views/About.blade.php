...
<html lang="en">
    <head>
        ...
        <title>VAS Gallery || Halaman About</title>
    ...
    <body id="page-top">
        ...
        <section class="page-section bg-dark" id="about">
            <div class="container">
                ...
                <ul>
                    <li>
                        <div><img class="rounded-circle" src="assets/img/about/5.jpg" width="200" height="250" alt="" /></div>
                        <div>
                            <div>
                                <br>
                                <h4>My Profile</h4>
                            ...
                            <div>
                                <p class="text-muted">
                                    Nama      : Vinka Amalia Safitri <br>
                                    TTL       : Banyuwangi, 6 Juni 2001 <br>
                                    Hobi      : Menggambar <br>
                                    Cita-cita : Web Developer <br>
                                    Alamat    : Jl. Raya Penataan, Kecamatan Winongan, Kabupaten Pasuruan.    
                                </p>
                            </div>
                        </div>
                    </li>
            ...
            <a class="btn btn-primary btn-xl text-uppercase" href="{{url('/article')}}">Next Page          <i class="fas fa-arrow-right"></i></a>
        </section>
        <!-- Footer-->
