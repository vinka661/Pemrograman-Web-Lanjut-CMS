...
<html lang="en">
    <head>
        ...
        <title>VAS Gallery || Halaman More Collection</title>
    ...
    <body id="page-top">
        ...
        @can('manage-articles')<div class="tombol float-left">
        ...
        <thead>
            <tr>
                ...
                <th>Merk</th>
                <th>Keterangan</th>
                @can('manage-articles')<th>Action</th>@endcan
            </tr>
        </thead>
        <tbody>
		    ...
		    <tr>
                ...
                @can('manage-articles')<td width="200">
    ...
    <br>
    <a class="btn btn-primary btn-xl text-uppercase" href="{{url('/product')}}"><i class="fas fa-arrow-left"></i>          Back to Collection</a>
    </section>
        <!-- Footer-->
