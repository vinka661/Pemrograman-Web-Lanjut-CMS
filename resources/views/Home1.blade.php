...
<html lang="en">
    <head>
        ...
        <title>VAS Gallery || Halaman Home</title>
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                ...
                <div class="masthead-heading text-uppercase">VAS GALLERY</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="{{url('/about')}}">Next Page          <i class="fas fa-arrow-right"></i></a>
            </div>
        </header>
        <!-- Footer-->
