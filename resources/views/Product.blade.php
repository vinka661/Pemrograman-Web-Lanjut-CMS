...
<html lang="en">
    <head>
        ...
        <title>VAS Gallery || Halaman Product</title>
        ...
        <section class="page-section bg-dark" id="portfolio">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Berisi koleksi-koleksi dari blog saya</h3>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <img class="img-fluid" src="assets/img/laptop/1.jpg" width="500" alt="" />
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <img class="img-fluid" src="assets/img/laptop/1-1.jpg" width="500" alt="" />
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Lenovo</div>
                                <div class="portfolio-caption-subheading text-muted">Lenovo Ideapad S340 14</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <img class="img-fluid" src="assets/img/laptop/2.jpg" width="500" alt="" />
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                        <div class="portfolio-item">
                            <img class="img-fluid" src="assets/img/laptop/4.jpeg" width="500" alt="" />
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">HP</div>
                                <div class="portfolio-caption-subheading text-muted">HP Omen DH0105TX</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                        <div class="portfolio-item">
                            <img class="img-fluid" src="assets/img/laptop/3.jpg" width="500" alt="" />
                            <div class="portfolio-caption">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="portfolio-item">
                            <img class="img-fluid" src="assets/img/laptop/5.jpg" width="500" alt="" />
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Asus</div>
                                <div class="portfolio-caption-subheading text-muted">Asus VivoBook S13 S330FA</div>
                            </div>
                        </div>
                    </div>
                </div>
                <a class="btn btn-primary btn-xl text-uppercase" href="{{url('/collect')}}">More Info          <i class="fas fa-arrow-right"></i></a>
            </div>
        </section>
        <!-- Footer-->
